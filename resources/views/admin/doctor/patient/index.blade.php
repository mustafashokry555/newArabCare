            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="doc-badge me-3">{{ __('admin.patient.patients')  }} <span class="ms-1">{{ count($patients) }}</span></div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="datatable table table-borderless hover-table" id="data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ __('admin.patient.address')  }}</th>
                                        <th>{{ __('admin.patient.member_since')  }}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @forelse($patients as $patient)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                @if($patient->address ?? '')
                                                    <span class="user-name">{{ $patient?->address }} </span>
                                                    <span class="d-block">{{ $patient?->city }}</span>
                                                    <span class="d-block">{{ $patient?->state }}</span>
                                                    <span class="d-block">{{ $patient?->country }}</span>
                                                    @else
                                                    N/A
                                                    @endif
                                                </td>
