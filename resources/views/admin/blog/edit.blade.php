                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">{{ __('admin.blogs.edit_blog') }}</h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('update_blog', $blog) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input id="blog_title_en" name="blog_title_en" type="text" class="form-control"
                                            value="{{ $blog->blog_title_en }}" required>
                                        @error('blog_title_en')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input id="blog_title_ar" name="blog_title_ar" type="text" class="form-control"
                                            value="{{ $blog->blog_title_ar }}" required>
                                        @error('blog_title_ar')
                                            <div class="text-danger pt-2">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea id="blog_body_en" name="blog_body_en" type="text" class="form-control" required>{{ $blog->blog_body_en }}</textarea>
                                        @error('blog_body_en')
                                            <div class="text-danger pt-2">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea id="blog_body_ar" name="blog_body_ar" type="text" class="form-control" required>{{ $blog->blog_body_ar }}</textarea>
                                        @error('blog_body_ar')
                                            <div class="text-danger pt-2">
                                                {{ $message }}
                                            </div>
